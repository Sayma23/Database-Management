...
--%>
    ...
    <div align="center">
        <table border="1" cellpadding="5">
            ...
            <c:forEach var="cool" items="${listOfVideos}">
                <tr>
                    <td><iframe width="420" height="315" src="${cool.url}"> </iframe></td>
                    <td><c:out value="${cool.title}" /></td>
                    <td><c:out value="${cool.question}" /></td>
                    <td>
                        <a href="question_detail?id=<c:out value='${cool.questionID}' />">Detail</a>
                        &nbsp;&nbsp;&nbsp;&nbsp;
