...
<head>
        ...
        <title>Positive Reviewers</title>
...
--%>
        ...
        <h2>List of positive reviewers</h2>
    ...
    <div align="center">
        <table border="1" cellpadding="5">
            ...
            <c:forEach var="user" items="${listOfRs}">
                <tr>
                    <td>
                        <a href="user_detail_review?user=<c:out value='${user}' />"><c:out value='${user}' /></a>
                        &nbsp;&nbsp;&nbsp;&nbsp;
