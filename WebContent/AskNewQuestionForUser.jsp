...
<body>
 ...
 <form action="ask_new_question" method="post">
        ...
        <h3>
          ...
          <input type="text" name="tag_1" size = "15" required>
          
          <label for="tag_2">Tag:</label>
          <input type="text" name="tag_2" size = "15" required>
          
          <label for="tag_3">Tag:</label>
          <input type="text" name="tag_3" size ="15" required>
